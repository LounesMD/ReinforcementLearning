...
def td(etats , actions , gamma , politique , init , est_final , etat_suivant ):
    ...
    while cpt < 100000: #Le problème ici, c'est qu'il faut vérifier les conditions (càd : passer une infinité de fois dans chaque état )
        t = 0
        ...
        while( not est_final(s[t]) ): #On vérifie le critère de l'état final
            ...
            print("on est dans l'état " + str(s[t]) +" et on fait l'action " + str(politique[s[t]]) )
