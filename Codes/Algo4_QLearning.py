...
def Q_Learning(etats , actions , gamma , execution , init , decision , final , environnement):
    ...
    while(cpt < 70): #On va faire 70 épisodes
        ...
        while   not final(s[t]) : #On va faire 1 épisode     
            ...
            d = decision(Q , actionsPossibles , s[t] , 1 ) #A utiliser si on veut utiliser la manière Boltzmann
...
data = list()        
for i in range(15):
    v = Q_Learning(etats_labyrinthe() , actions_labyrinthe() , 0.9 , exectution_labyrinthe , init_labyrinthe , boltzmann  , est_final_labyrinthe , maze)   
    data.append(v )
