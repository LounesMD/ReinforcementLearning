...
def Q_Learning(init , final , actions , execution , decision , gamma , AcceptableActions):
    ...
    while(cpt < 4003): #On va faire 70 épisodes
        ...
        while   (not final(s[t])) and k<220: 
            ...
            d = decision(Q , actionsPossibles , i_disc , j_disc , 1 ) #A utiliser si on veut utiliser la manière Boltzmann
            ...
            Q[i_disc][j_disc][action] = Q[i_disc][j_disc][action] + alpha * (r[t] + gamma*v - Q[i_disc][j_disc][action])            
